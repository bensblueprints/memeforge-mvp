...
Don't want to build from source? Get the signed installer, lifetime updates and setup support for a one-time payment at [onetimesuite.com/memeforge](https://onetimesuite.com/memeforge/) — same app, MIT source right here.
